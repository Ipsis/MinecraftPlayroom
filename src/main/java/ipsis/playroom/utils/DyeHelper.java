...
import ipsis.playroom.OreDictHelper;
...
public class DyeHelper {
    ...
    public static enum DyeType {
        ...
        BLUE(4, "dyeBlue", ColorHelper.DYE_BLUE),
        ...
        INVALID(99, "NO VALID DYE", ColorHelper.DYE_WHITE);
        ...
        public static DyeType getDye(String dyeName) {

            for (DyeType r : VALID_DYES)
                if (r.getOreDict().equals(dyeName))
                    return r;
